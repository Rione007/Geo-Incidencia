namespace Backend_Geo_Incidencia.Shared
{
    public class DbConstantes
    {
        ...
        public const string SpListarIncidenciasPorUsuarioId = "dbo.SP_LISTAR_INCIDENCIAS_POR_USUARIO";
        public const string SpListarIncidencias = "SP_LISTAR_INCIDENCIAS";


        //faltan apis
        public const string SpBuscarIncidenciasPorArea = "dbo.SP_BUSCAR_POR_AREA";
        public const string SpBuscarIncidenciasPorRadio = "dbo.SP_BUSCAR_POR_RADIO";
        public const string SpObtenerHeatmap = "dbo.SP_OBTENER_HEATMAP";
